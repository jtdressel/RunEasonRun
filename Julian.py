...
'''
	def __init__(self, pos, up, lo, level):
		...
		anim_front = [self.images1_2[0],self.images1_1[0],self.images1_0[0],self.images1_0[0],self.images1_0[0],self.images1_0[0],self.images1_0[0]]#inefecient, but dealing wiht a malformed sprite sheet
		...
		self.anim_attack_punch = Animation(punch_list, 10, False)
